...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const activeSection: SectionType = pathname.includes('/contact') ? 'contact' : pathname.includes('/services') ? 'services' : pathname.includes('/reviews') ? 'reviews' : pathname.includes('/gallery') ? 'gallery' : 'home';
