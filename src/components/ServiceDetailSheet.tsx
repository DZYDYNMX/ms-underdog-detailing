...
export const ServiceDetailSheet: React.FC<ServiceDetailSheetProps> = ({ serviceId, onClose, onBook }) => {
  ...
  const detailsMap: Record<string, {
    ...
    'full-detail': {
      ...
      prices: [
        { category: 'Coupes & Sedans', price: '$260' },
        { category: "Mid-size Trucks & SUVs", price: '$280' },
        { category: "Large Trucks & 3-Row SUVs", price: '$300' },
        { category: "Extra Large & Vans", price: '$340' }
      ],
      includesExterior: [
    ...
    'express-detail': {
      ...
      prices: [
        { category: 'Sedans & Coupes', price: 'From $100' },
        { category: 'Midsize Cars & SUVs', price: '$125+' },
        { category: 'Large Trucks & SUVs', price: '$135' },
        { category: 'Trucks & Trailers', price: '$230' },
        { category: 'Dump Trucks', price: '$250' }
      ],
      includesExterior: [
